...
class BranchAdminPersonalTemplateScreen extends StatefulWidget {
  BranchAdminPersonalTemplateScreen({super.key, required this.size});
  // ignore: prefer_typing_uninitialized_variables
  Size size;

  @override
  State<BranchAdminPersonalTemplateScreen> createState() => _BranchAdminPersonalTemplateScreenState();
}

class _BranchAdminPersonalTemplateScreenState extends State<BranchAdminPersonalTemplateScreen> {
  @override
