...
import '../../add_branch_admin/provider/branch_provider.dart';
        ...
        children: [
          ...
          Expanded(
              child: InkWell(
                  ...
                  child: text('Admin Templates', size: 18.0, color: Colors.black, fontWeight: FontWeight.w500))),
          Expanded(
              child: InkWell(
                  onTap: () {
          ...
          Expanded(
              child: InkWell(
                  ...
                  child: text('Branches', size: 18.0, color: Colors.black, fontWeight: FontWeight.w500))),
          Expanded(
              child: Row(
            children: [
