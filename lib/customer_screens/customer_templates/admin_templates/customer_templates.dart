...
class CustomerTemplate extends StatefulWidget {
  CustomerTemplate({super.key, required this.size});
  // ignore: prefer_typing_uninitialized_variables
  Size size;

  @override
  State<CustomerTemplate> createState() => _CustomerTemplateState();
}

class _CustomerTemplateState extends State<CustomerTemplate> {
  @override
        ...
        children: [
          ...
          SizedBox(
              ...
              child: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance.collection('Standards').snapshots(),
