...
class PersonalTemplateScreen extends StatefulWidget {
  PersonalTemplateScreen({super.key, required this.size});
  // ignore: prefer_typing_uninitialized_variables
  Size size;

  @override
  State<PersonalTemplateScreen> createState() => _PersonalTemplateScreenState();
}

class _PersonalTemplateScreenState extends State<PersonalTemplateScreen> {
  @override
        ...
        children: [
          ...
          SizedBox(
            ...
            child:StreamBuilder<QuerySnapshot>( 
               stream: FirebaseFirestore.instance.collection('StandardsCopy').where('customerId',isEqualTo:customerProvider.customerId ).snapshots(),
              ...
              itemBuilder: (context, index) {
                return ItemTile(index,snapshot.data!.docs[index]['name'].toString(),snapshot.data!.docs[index]['id'].toString());
              },
